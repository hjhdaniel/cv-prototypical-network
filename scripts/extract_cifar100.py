...
# Combine Test Train into one folder
for batch in ('test', 'train'):
   fpath = os.path.join('../dataset/CIFAR/', 'cifar-100-python', batch)

   f = open(fpath, 'rb')
   labels = pickle.load(open(os.path.join('../dataset/CIFAR/', 'cifar-100-python', 'meta'), 'rb'), encoding="ASCII")
