...
class DataLoader(object):
    ...
    def set_data_loader(self):
        ...
        if self.arg_settings.data == 'omniglot':
            ...
            if self.mode == "train":
                dataset = datasets.CIFAR100(root=self.arg_settings.dataset_root + '/CIFAR/', train=True,
                                            transform=trans, target_transform=None, download=True)
            else:
                dataset = datasets.CIFAR100(root=self.arg_settings.dataset_root + '/CIFAR/', train=False,
                                            transform=trans, target_transform=None, download=True)
